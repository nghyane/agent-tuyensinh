...
class TemplateManager:
    ...
    def _get_result_template_data(self, language: str) -> ResultTemplateData:
        ...
        return ResultTemplateData(
            ...
            action_suggestions_header=template_data.get('action_suggestions_header', '💡 ACTION SUGGESTIONS:'),
    ...
    def render_result_template(self, context: TemplateContext, language: str = "vi") -> str:
    ...
    def _render_basic_info(self, context: TemplateContext, template: ResultTemplateData) -> str:
    ...
    def _render_suggestions(self, suggestions: List[str], template: ResultTemplateData) -> str:
    ...
    def format_metadata(self, metadata: Dict[str, Any], language: str = "vi") -> str:
        ...
        formatters = {
            ...
            "confidence_adjusted": lambda _: labels.get('confidence_adjusted', '🎯 Confidence adjusted'),
