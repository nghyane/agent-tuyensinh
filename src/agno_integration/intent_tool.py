...
class IntentDetectionTool(Toolkit):
    ...
    async def detect_intent(self, query: str, user_id: str = "agno_user", language: Optional[str] = None) -> str:
        ...
        try:
            ...
            return self._handle_timeout_error(query, language)
        except Exception as e:
            return self._handle_general_error(query, language, str(e))
...
def create_intent_detection_tool(intent_service: HybridIntentDetectionService) -> IntentDetectionTool:
    """
